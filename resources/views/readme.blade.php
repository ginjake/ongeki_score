        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <li><a id="result_anchor" href="javascript:if(location.href.indexOf('https://ongeki-net.com/ongeki-mobile/') == 0){$.getScript('//www.ginjake.net/ongeki/public/js/ongeki_score.js')}else{location.href = 'https://ongeki-net.com/ongeki-mobile/home/'};">オンゲキブックマークレット</a>登録</li>
                  ...
                  <div><a href="{{ url('top') }}">TOPに戻る</a></div>
                </div>
            </div>
        </div>
    </div>
